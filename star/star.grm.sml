fn _ => let val  (ID as ID1) = ID1 ()
 val  (exp_ as exp_1) = exp_1 ()
 in (Ast.MutateStmt(ID, exp_, IDleft, IDright))
end)
 in ( LrTable.NT 12, ( result, ID1left, exp_1right), rest671)
end
|  ( 6, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( MlyValue.body_ body_1,
...
|  ( 7, ( ( _, ( _, _, RBRACE2right)) :: ( _, ( MlyValue.body_ body_2,
...
|  ( 8, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( MlyValue.body_ body_1,
 _, _)) :: _ :: _ :: ( _, ( MlyValue.bool_ bool_1, _, _)) :: _ :: ( _,
...
|  ( 9, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.exp_ exp_1, _
...
|  ( 10, ( ( _, ( _, (BREAKleft as BREAK1left), (BREAKright as 
...
|  ( 11, ( ( _, ( _, (CONTINUEleft as CONTINUE1left), (CONTINUEright
...
|  ( 12, ( ( _, ( _, (RETURNleft as RETURN1left), (RETURNright as 
RETURN1right))) :: rest671)) => let val  result = MlyValue.stm_ (fn _
 => (Ast.RETURN(RETURNleft, RETURNright)))
 in ( LrTable.NT 12, ( result, RETURN1left, RETURN1right), rest671)

end
|  ( 13, ( rest671)) => let val  result = MlyValue.functionCallParams_
 (fn _ => ([]))
 in ( LrTable.NT 13, ( result, defaultPos, defaultPos), rest671)
end
|  ( 14, ( ( _, ( MlyValue.exp_ exp_1, exp_1left, exp_1right)) :: 
...
|  ( 15, ( ( _, ( MlyValue.functionCallParams_ functionCallParams_1, _
...
|  ( 16, ( ( _, ( MlyValue.NUM NUM1, (NUMleft as NUM1left), (NUMright
...
|  ( 18, ( ( _, ( MlyValue.ID ID1, (IDleft as ID1left), (IDright as 
...
|  ( 20, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.exp_ exp_1,
...
|  ( 21, ( ( _, ( MlyValue.exp_ exp_2, _, exp_2right)) :: ( _, ( 
...
|  ( 22, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.ID ID1, _, _
)) :: _ :: ( _, ( _, (JSleft as JS1left), JSright)) :: rest671)) =>
 let val  result = MlyValue.exp_ (fn _ => let val  (ID as ID1) = ID1
 ()
 in (Ast.JsExp(ID, JSleft, JSright))
end)
 in ( LrTable.NT 0, ( result, JS1left, RPAREN1right), rest671)
end
|  ( 23, ( ( _, ( _, (PLUSleft as PLUS1left), (PLUSright as PLUS1right
...
|  ( 24, ( ( _, ( _, (TIMESleft as TIMES1left), (TIMESright as 
...
|  ( 28, ( ( _, ( MlyValue.body_ body_1, _, body_1right)) :: ( _, ( 
...
|  ( 29, ( ( _, ( MlyValue.stm_ stm_1, (stm_left as stm_1left), (
...
|  ( 40, ( ( _, ( MlyValue.bool_ bool_2, _, bool_2right)) :: ( _, ( 
...
|  ( 41, ( rest671)) => let val  result = MlyValue.params_ (fn _ => (
[]))
...
|  ( 43, ( ( _, ( MlyValue.params_ params_1, _, params_1right)) :: _
...
|  ( 44, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( MlyValue.body_ body_1
...
ParserData.MlyValue.VOID,p1,p2))
fun JS (p1,p2) = Token.TOKEN (ParserData.LrTable.T 35,(
ParserData.MlyValue.VOID,p1,p2))
end
end
