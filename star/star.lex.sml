       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp <= #"@"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ32(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction29(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp <= #"@"
                  then yyAction29(strm, yyNO_MATCH)
                  else yyQ32(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction28(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp <= #"@"
                  then yyAction28(strm, yyNO_MATCH)
                  else yyQ32(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"l"
              ...
              then if inp = #"m"
                  then yyQ32(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
                  else yyQ57(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ32(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
              else yyAction34(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then yyQ32(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp < #"a"
              then yyAction24(strm, yyNO_MATCH)
            else if inp <= #"z"
              then yyQ32(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
...
fun yyQ16 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction11(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ73(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
